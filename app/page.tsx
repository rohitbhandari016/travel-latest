...
export default function Home() {
  const a = [{ id: 1, name: "Badrinath", price: 5000 }, { id: 2, name: "Devprayag", price: 7000 }, { id: 3, name: "Gangotri", price: 6000 }, { id: 4, name: "Kedarkantha", price: 8000 }, { id: 5, name: "Harshil", price: 12000 }, { id: 6, name: "Auli", price: 9000 },]
  return (
    <div className='p-10'>
      <div className='grid grid-cols-4 gap-8'>
        {
          a.map(item =>
            <div key={item.id}>
              <Link href={`/places/${item.id}`}  className="c-card block bg-white shadow-md hover:shadow-xl rounded-lg overflow-hidden">
                <div className="relative h-40 w-auto">
                  <Image src={`/image${item.id}.jpg`} alt="image" fill={true} className="w-full h-full relative" objectFit='cover' />
                </div>
                <div className="p-4">
                  ...
                  <div className="mt-3 flex items-center">
                    <span className="text-sm font-semibold">ab</span>&nbsp;<span className="font-bold text-xl">{item.price}</span>&nbsp;<span className="text-sm font-semibold">€</span>
                  </div>
                </div>
